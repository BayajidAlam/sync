...
class VideoProcessor {
        ...
        try {
            ...
            console.error("Webhook failed:", {
                ...
                status: hasAxiosResponse
                    ? (_a = webhookError.response) === null || _a === void 0 ? void 0 : _a.status
                    : undefined,
                data: hasAxiosResponse
                    ? (_b = webhookError.response) === null || _b === void 0 ? void 0 : _b.data
                    : undefined,
            });
        }
    }
    ...
    async uploadProcessedFiles(outputDir) {
        ...
        try {
            ...
            console.log(`All files uploaded successfully. Total size: ${(totalSize /
                1024 /
                1024).toFixed(2)} MB`);
            return results;
        }
