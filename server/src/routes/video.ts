...
router.get('/stats/overview', async (req: express.Request, res: express.Response): Promise<void> => {
  try {
...
router.get('/status/:status', async (req: express.Request, res: express.Response): Promise<void> => {
  try {
...
router.get('/:id', validateVideoId, async (req: express.Request, res: express.Response): Promise<void> => {
  try {
    const { id } = req.params
...
// Get video status
router.get('/:id/status', validateVideoId, async (req: express.Request, res: express.Response): Promise<void> => {
  try {
    const { id } = req.params
    const video = await videoService.getVideoById(id)
...
// Get DASH manifest
router.get('/:id/manifest.mpd', validateVideoId, async (req: express.Request, res: express.Response): Promise<void> => {
  try {
    const { id } = req.params
    const video = await videoService.getVideoById(id)
